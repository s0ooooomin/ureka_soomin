...
<body>
	...
	<script>
		...
		window.onload = function() {
			...
			document.querySelector("#btnSearch").onclick = searchMovie; // 검색 버튼
			
		}
		async function listMovie(searchWord="") {
			
			// 데이터 요청
			let url = '/movies/list?searchWord=${searchWord}';
